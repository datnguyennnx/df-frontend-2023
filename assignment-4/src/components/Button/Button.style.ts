export const styles = {
  base: 'relative font-medium duration-200 whitespace-nowrap',
  ...
  appearance: {
    ...
    default:
      ' rounded-md p-2 border focus:outline-none focus:ring-2 focus:ring-offset-2 border-gray-400 text-gray-700 bg-white hover:bg-gray-50 focus:ring-pink-500 px-4',
  },
  fullWidth: {
    true: 'flex w-full',
  },
